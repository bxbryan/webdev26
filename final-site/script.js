...
const finalHeroStyle = {
  family: '"Diatype", "ABC Diatype", "Helvetica Neue", Arial, sans-serif',
  leftStyle: "normal",
  rightStyle: "normal",
  leftWeight: "400",
  rightWeight: "400",
...
if (reduceMotion) {
  ...
  setHeroCase("title");
  firstName.style.fontFamily = '"Diatype", "ABC Diatype", "Helvetica Neue", Arial, sans-serif';
  firstName.style.fontStyle = "normal";
  firstName.style.fontWeight = "400";
  lastName.style.fontFamily = '"Diatype", "ABC Diatype", "Helvetica Neue", Arial, sans-serif';
